...
{
    return int(int( TempData.BoundRadiusY + Target->TempData.BoundRadiusY + TempData.Attr.MainAttackRange ) + TempData.Attr.Mid.Body[EM_WearEqType_AttackRange]);	

}
int	RoleDataEx::SecAttackRange( RoleData* Target )
{
	return int(int( TempData.BoundRadiusY + Target->TempData.BoundRadiusY + TempData.Attr.SecAttackRange ) + TempData.Attr.Mid.Body[EM_WearEqType_AttackRange]);	
