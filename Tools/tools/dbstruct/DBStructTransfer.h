		...
		Iter++ , i++ )
	{
		...
		else if(IDData->AddressFlag == ENUM_Indirect_Address)
		{
			...
			case ENUM_Type_FloatPoint:
				bindResult = Proxy_SQLBindCol( dbhstmt , i , SQL_C_FLOAT  , (SQLPOINTER)(IDData->Point + INT64(&OutData)) , SQL_C_DEFAULT  , NULL );
				break;

			case ENUM_Type_IntPoint:
				bindResult = Proxy_SQLBindCol( dbhstmt , i , SQL_C_LONG   , (SQLPOINTER)(IDData->Point + INT64(&OutData)) , SQL_C_DEFAULT  , NULL );
				break;

			case ENUM_Type_ShortPoint:
				bindResult = Proxy_SQLBindCol( dbhstmt , i , SQL_C_SHORT  , (SQLPOINTER)(IDData->Point + INT64(&OutData)) , SQL_C_DEFAULT  , NULL );
				break;

			case ENUM_Type_CharString:
				bindResult = Proxy_SQLBindCol( dbhstmt , i , SQL_C_CHAR   , (SQLPOINTER)(IDData->Point + INT64(&OutData)) , IDData->Size  , NULL );
				break;

			case ENUM_Type_WCharString:
				bindResult = Proxy_SQLBindCol( dbhstmt , i , SQL_C_WCHAR  , (SQLPOINTER)(IDData->Point + INT64(&OutData)) , IDData->Size  , NULL );
				break;
			...
			case  ENUM_Type_BinaryData:
				bindResult = Proxy_SQLBindCol( dbhstmt , i , SQL_C_BINARY , (SQLPOINTER)(IDData->Point + INT64(&OutData)) , IDData->Size  , NULL );
				break;
			case ENUM_Type_BitPoint:
				bindResult = Proxy_SQLBindCol( dbhstmt , i , SQL_C_BIT    , (SQLPOINTER)(IDData->Point + INT64(&OutData)) , SQL_C_DEFAULT  , NULL );
				break;
    ...
    if( strlen( WhereCmd ) == 0 )
    {
                ...
                Iter++  )
        {
            ...
            if(IDData->AddressFlag == ENUM_Indirect_Address )
            {
                ...
                case ENUM_Type_FloatPoint:
                    {               
                        float Value = *(float*)(IDData->Point + INT64(Data));
                ...
                case ENUM_Type_IntPoint:
                    {
                        int Value = *((int*)(IDData->Point + INT64(Data)));
                        sprintf( Buf ,"%d" , Value  );
                    }break;              
                case ENUM_Type_ShortPoint:
                    {                    
                        short Value = *((short*)(IDData->Point + INT64(Data)));
                        sprintf( Buf ,"%d" , Value  );
                    }                
                    break;
				case ENUM_Type_BitPoint:
					{
						bool	Value = *((bool*)(IDData->Point + INT64(Data)));
						sprintf( Buf ,"%d" , Value  );
					}
					break;
                case ENUM_Type_CharString:
                    {
                        char* Str = ((char*)(IDData->Point + INT64(Data)));
                        sprintf( Buf , "'%s'", Str );
                    }                
                    break;
				case ENUM_Type_BinaryData:
				...
				case ENUM_Type_SmallDateTime:
					{
						float Value = *((int*)(IDData->Point + INT64(Data)));
						sprintf( Buf , "%f", Value );
					}
					break;
