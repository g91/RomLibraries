...
static unsigned char UNIQUE_STOC_KEY[UNIQUE_KEY_SIZE] = { 77, 202, 157, 203, 171, 12, 16, 44 };
static unsigned char UNIQUE_MTOC_KEY[UNIQUE_KEY_SIZE] = { 99, 6, 79, 150, 52, 202, 219, 165 };
static unsigned char UNIQUE_CTOS_KEY[UNIQUE_KEY_SIZE] = { 139, 227, 251, 154, 253, 167, 55, 45 };
static unsigned char UNIQUE_CTOM_KEY[UNIQUE_KEY_SIZE] = { 138, 111, 185, 207, 35, 203, 191, 65 };
static unsigned char UNIQUE_ERROR_KEY[UNIQUE_KEY_SIZE] = { 153, 108, 89, 171, 62, 43, 116, 133 };
