...
public:
	...
	virtual LONG GetBytesSend(int Second) = 0;
	virtual LONG GetBytesRecv(int Second) = 0;
	virtual LONG GetPacketsSend(int Second) = 0;
	virtual LONG GetPacketsRecv(int Second) = 0;
