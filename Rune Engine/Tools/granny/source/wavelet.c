...
#define ALIGN_8_TYPE __m64

#endif


// forward transforms a row with the DWT
void fDWTrow( S16* dest, U32 ppitch, S16 const* input, U32 inpitch, U32 width, U32 height, U32 starty, U32 subheight )
{
  U32 y;
...
void fDWTcol( S16* dest, U32 pitch, S16 const* input, U32 inpitch, U32 width, U32 height, U32 starty, U32 subheight )
{
  U32 x;
  char const *in;
  char const *end;
...
void fHarrrow( S16* dest, U32 ppitch, S16 const* input, U32 inpitch, U32 width, U32 height, U32 starty, U32 subheight )
{
  U32 y;
  char const * in;
  char * hout, *lout;
...
void fHarrcol( S16* dest, U32 pitch, S16 const* input, U32 inpitch, U32 width, U32 height, U32 starty, U32 subheight )
{
  U32 x;
  char const *in;
  char *out;
...
void fDWT2D( S16* input, U32 pitch, U32 width, U32 height, S16* temp )
{
  #define FLIPSIZE 8
...
void iDWTrow( S16 * dest, U32 pitch, S16 const * in, U32 ppitch, U32 width, U32 height, U8 const * row_mask, U32 starty, U32 subheight )
{
  U32 y;
  char *out, *hin, *lin;
  U32 halfwidth;
...
void iDWTcol( S16 * dest, U32 pitch, S16 const * input, U32 ppitch, U32 width, U32 height, U32 starty, U32 subheight )
{
  U32 x;
  char *out;
  char const *lin;
...
void iHarrrow( S16 * dest, U32 pitch, S16 const * in, U32 ppitch, U32 width, U32 height, U8 const * row_mask, U32 starty, U32 subheight )
{
  U32 y;
  char *out, *hin, *lin;
  U32 halfwidth;
...
void iHarrcol( S16 * dest, U32 pitch, S16 const * input, U32 ppitch, U32 width, U32 height, U32 starty, U32 subheight )
{
  U32 x;
  char *out;
  char const *lin;
...
void iDWT2D( S16* output, U32 pitch, U32 width, U32 height, U8 const * row_mask, S16* temp )
{
  #define FLIPSIZE 8
