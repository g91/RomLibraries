...
EXPTYPE_EPHEMERAL struct camera
{
    ...
    triple Position;
    triple EAR; // Elevation/Azimuth/Roll
    triple Offset;
...
EXPAPI GS_SAFE real32 FindAllowedLODError(real32 ErrorInPixels, int32x ViewportWidthInPixels, real32 CameraFOV, real32 DistanceFromCamera);
