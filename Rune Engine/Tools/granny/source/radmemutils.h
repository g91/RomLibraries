...
//      #define radmemset memset
      ...
      void radmemset16(void* dest,U16 value,U32 size);
       ...
       "inc esi" "inc edi" "jmp lp" "set:" "setne al" "jbe end" "neg al" "end:" \
        ...
        static void __inline radmemset16(void* dest,U16 value,U32 size)
        {
...
#define OutputDebugString  OutputDebugStringA
          ...
          static void __inline radmemset16(void* dest,U16 value,U32 sizeb) {
            __asm {
              mov edi,[dest]
              mov ax,[value] 
              mov ecx,[sizeb]
          ...
          static void __inline radmemset32(void* dest,U32 value,U32 sizeb) {
            __asm {
              mov edi,[dest]
              mov eax,[value]
              mov ecx,[sizeb]
