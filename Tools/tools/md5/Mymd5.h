...
class MyMD5Class
{
	...
	const char* _ComputeByteHash(const unsigned char* data, const char* XorStr, int size);
...
public:
	...
	const char* ComputeByteHash(const unsigned char* data, const char* XorStr, int size);
