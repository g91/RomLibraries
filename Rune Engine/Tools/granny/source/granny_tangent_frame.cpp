             ...
             ++Side)
        {
                                                    ...
                                                    Builder.TangentMergingMinCosine))
            {
                ...
                int32x NewVertexIndex;
                {
                    ...
                    if (NewStackUnit(Builder.VertexStack, NewVertexIndex) == false ||
                        NewStackUnit(Builder.VertexTangentStack, NewTangentIndex) == false ||
                        NewStackUnit(Builder.FromTriangleStack, NewTriMapIndex) == false ||
                        NewStackUnit(Builder.NextCoincidentVertStack, NewNextVertIndex) == false)
                    {
                        // Failure
                        return false;
                    }
