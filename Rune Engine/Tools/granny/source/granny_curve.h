...
// // "d4ni1" = 4-dimensional normalized data implemented as 1-d
// // "k16u" = 16-bit int knots
// // "c16u" = 16 bit integer controls.
// // This represents rotations that are around one axis only.  Stores theta
// // around RotAxis
// EXPTYPE struct curve_data_d4ni1_k16u_c16u
// {
//  curve_data_header CurveDataHeader;
//  uint16 OneOverKnotScaleTrunc;
//  uint16 BaseQuaternion[4];
//  uint16 RotationAxis[3];
//  uint16 ValueRange;  // 0 - 3 scaled
//  real32 ValueStart;
//  int32  KnotControlCount;    // KnotCount + ControlCount (and we know that ControlCount = KnotCount)
//  uint16 *KnotsControls;      // First half is Knots, last half is Controls.
// };
// EXPCONST EXPGROUP(curve_data_d4ni1_k16u_c16u) extern data_type_definition CurveDataD4nI1K16uC16uType[];


// // "d4ni1" = 4-dimensional normalized data implemented as 1-d
// // "k8u" = 8-bit int knots
// // "c8u" = 8 bit integer controls.
// // This represents rotations that are around one axis only.  Stores theta
// // around RotAxis
// EXPTYPE struct curve_data_d4ni1_k8u_c8u
// {
//  curve_data_header CurveDataHeader;
//  uint16 OneOverKnotScaleTrunc;
//  uint16 BaseQuaternion[4];
...
//  uint8 *KnotsControls;       // First half is Knots, last half is Controls.
// };
// EXPCONST EXPGROUP(curve_data_d4ni1_k8u_c8u) extern data_type_definition CurveDataD4nI1K8uC8uType[];
...
EXPAPI GS_READ bool CurveFormatIsInitializedCorrectly(curve2 const &Curve);
