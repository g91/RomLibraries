...
ReaderClass<WebShopBagItemFieldDBStruct>*	RoleDataEx::ReaderRD_WebShopBag( )
{
	...
	{   
		...
		Reader.SetData( "PriceType"			, &Pt->PriceType				, ENUM_Type_IntPoint		);
		Reader.SetData( "Price"				, &Pt->Price					, ENUM_Type_IntPoint		);
		Reader.SetData( "AddBonusMoney"		, &Pt->AddBonusMoney			, ENUM_Type_IntPoint		);
		IsReady = true;
	}
	return &Reader;
}
