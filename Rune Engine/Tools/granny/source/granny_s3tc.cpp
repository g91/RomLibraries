...
unsigned int find3from012(int c0, int c1, int c2)
{
    ...
    if (COLOR_1(c0, c3) == c1 && COLOR_2(c0, c3) == c2)
        return c3;
    else if (COLOR_1(c0, c3-1) == c1 && COLOR_2(c0, c3-1) == c2)
        return c3-1;
    else if (COLOR_1(c0, c3+1) == c1 && COLOR_2(c0, c3+1) == c2)
        return c3+1;
...
unsigned int find0from123(int c1, int c2, int c3)
{
    ...
    if (COLOR_1(c0, c3) == c1 && COLOR_2(c0, c3) == c2)
        return c0;
    else if (COLOR_1(c0-1, c3) == c1 && COLOR_2(c0-1, c3) == c2)
        return c0-1;
    else if (COLOR_1(c0+1, c3) == c1 && COLOR_2(c0+1, c3) == c2)
        return c0+1;
