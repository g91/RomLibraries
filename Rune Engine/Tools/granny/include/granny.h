...
/* ========================================================================
...
#elif _XBOX
  #if _XENON
    #error Shouldn never have got here (dll_header.h)
  #endif
  #define GRANNY_DYNIMP(ret) ret __stdcall
  #define GRANNY_DYNEXP(ret) ret __stdcall
  #define GRANNY_CALLBACK(ret) ret __cdecl
  #define GRANNY_DYNIMPDATA(type) type
  #define GRANNY_DYNEXPDATA(type) type
#elif _PSX2 || _GAMECUBE || __psp__ || __CELLOS_LV2__
...
#define GrannyCurrentGRNStandardTag (0x80000000 + 24)
...
#define GrannyProductVersion "2.6.0.16"
#define GrannyProductMajorVersion 2
#define GrannyProductMinorVersion 6
#define GrannyProductCustomization 0
#define GrannyProductBuildNumber 16
...
GRANNY_DYNLINK(granny_int32x) GrannyFitBSplineToSamples(granny_bspline_solver * Solver,
                                                        ...
                                                        granny_int32x MaximumCurveDataSizeInBytes,
                                                        bool * AchievedTolerance,
                                                        granny_int32x * CurveDataSizeInBytes);
...
GRANNY_DYNLINK(void) GrannyReadFileSectionInPlace(granny_file_reader * Reader,
                                                  ...
                                                  granny_int32x SectionIndex,
                                                  void * Memory);
GRANNY_DYNLINK(void) GrannyFixupFileSectionPhase1(granny_file_reader * Reader,
                                                  granny_file * File,
                                                  granny_int32x SectionIndex);
...
GRANNY_DYNLINK(void) GrannyModulationCompositeLocalPose(granny_local_pose * BasePose,
                                                        ...
                                                        granny_track_mask * Mask,
                                                        granny_local_pose * CompositePose);
GRANNY_DYNLINK(void) GrannyCopyLocalPose(granny_local_pose * Src,
...
GRANNY_DYNLINK(void) GrannyGetVectorDifferences(granny_int32x VectorDimension,
                                                ...
                                                bool EvaluateAsVectors,
                                                bool EvaluateAsQuaternions,
...
GRANNY_DYNLINK(granny_track_group *) GrannyEndTrackGroupInPlace(granny_track_group_builder * Builder,
                                                                void * Memory);
GRANNY_DYNLINK(void) GrannyPushVectorTrack(granny_track_group_builder * Builder,
                                           char * Name,
                                           granny_int32x Degree,
                                           granny_int32x Dimension,
                                           granny_real32 Duration,
                                           ...
                                           granny_real32 const * Knots,
                                           granny_real32 const * Controls,
                                           granny_data_type_definition const * CurveDataTypeDefinition);
